...
import blueSquares from "/images/blue-squares.svg";
  ...
  return (
    <div className="h-dvh flex flex-col justify-end relative gap-20 xs:gap-28 lg:gap-36 2lg:gap-16 pb-4 md:pb-0">
      ...
      <div className="flex flex-col gap-2 md:gap-6 2lg:gap-0">
        ...
        <h1
          id="h1"
          className="text-[12vw] leading-[45px] xs:leading-[50px] md:leading-[100px] lg:leading-[120px] 2lg:leading-normal 2lg:text-[6.2vw] xl:text-[6.3vw] 2xl:text-[6.41vw] font-medium"
        >
          FRONTEND DEVELOPER
        </h1>
      </div>
